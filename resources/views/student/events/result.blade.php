        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <div class="card shadow border-0 rounded-4 overflow-hidden mb-5">
                    <div class="card-header bg-gradient bg-warning text-dark text-center py-5">
                        <h5 class="text-uppercase letter-spacing-2 opacity-75 mb-3">{{ $participant->event->title }}</h5>
                        <h1 class="display-1 fw-bold mb-0">{{ $participant->score ?? 0 }}</h1>
                        <!-- <p class="fs-5 opacity-75">Total Score</p> -->
                        
                        <div class="mt-4">
                            <span class="badge bg-dark text-warning px-3 py-2 rounded-pill shadow-sm fs-6">
